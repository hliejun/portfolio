      ...
      <div v-for='link in links' :key='link.label' class='link'>
        <div class='card link__container'>
          <nuxt-link class='code link__content' v-bind:to='link.url'>
            <svg id='home-icon' class='menu__link-icon' viewBox='0 0 24 24' v-if="link.url === '/'">
            ...
            <svg id='work-icon' class='menu__link-icon' viewBox='0 0 24 24' v-if="link.url === '/work'">
              <path fill='none' d='M0 0h24v24H0V0z' />
              <path fill='currentColor' d='
            ...
            <svg id='logs-icon' class='menu__link-icon' viewBox='0 0 24 24' v-if="link.url === '/logs'">
              <path fill='none' d='M0 0h24v24H0V0z' />
              <path fill='currentColor' d='
