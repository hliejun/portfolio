<template>
  <div class='page foodlogging project'>
    ...
    <div class='page__content'>
      ...
      <!-- Built Using: Marvel App, CogTool -->

      <!-- About: UI/UX prototype built with considerations of various UI/UX principles and laws, improvement on existing prototype interface -->
      <!-- Motivations: Application of UI/UX laws and principles to practical design implementations. -->

      <!-- Findings: (See report) -->
      <!-- Video of original interaction design -->
      <!-- Marvel embed of 2 interaction designs -->
    ...
    return {
      jumbotron: {
        ...
        actions: [
          {
            label: 'Marvel Mockup',
            url: 'https://marvelapp.com/3aifcdb'
          },
          {
            label: 'Deck',
