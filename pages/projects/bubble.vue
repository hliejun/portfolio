<template>
  <div class='page bubble project'>
    ...
    <div class='page__content'>
      ...
      <!-- Built Using: React Native, socket.io, NodeJS (Express), Nginx -->
      <!-- Dev Tools Involved: NPM, ESLint -->
      ...
      <!-- Features:  -->
      <!-- Screenshots and video of interaction -->
...
export default {
  ...
  data () {
    return {
      jumbotron: {
        title: 'Bubble Chat',
        subtitle: 'Group project on problem-solving and stress management anonymous chat application.',
        actions: [
          {
            label: 'Project Repo',
            url: 'https://github.com/CS3216-Bubble'
          }
        ]
      },
      mockup: {
